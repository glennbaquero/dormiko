...
<div class="content-wrapper">
	<div class="box box-default">
      	<div class="box-header with-border">
        	<h1 class="box-title"><b>Update tenant</b></h1>
	        <section class="content-header">
	      		<ol class="breadcrumb">
					...
					<li class="active">
						<a href=""><i class="fas fa-images"></i> Update</a>
					</li>
				</ol>
	      	</section>
      	</div>
		...
		<div class="row">
			<div class="col-xs-12">
				{{-- <form @submit.prevent="formSubmit" 
					data-action="{{ route('contract.update.info', $item->id) }}" 
					        		...
					        		<div class="row">
					        			<div class="col-md-12"> --}}
					            			<contract-create ref="contract-create"
						            			:fetchurl="'{{ route('tenant.fetch', $item->id) }}'"
												:buildings="{{ $buildings }}"
												:rooms="{{ $rooms }}"
												url="{{ route('contract.update.info', $item->id) }}"
												:update="true"
					            			></contract-create>
					            		{{-- </div>
						        	</div>
