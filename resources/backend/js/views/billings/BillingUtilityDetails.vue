<template>
	<div>
        <div class="row">
            ...
            <div class="col col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="payment_date" v-model="item.invoice.payment_date">
                </div>
            </div>
    		<div class="col col-xs-12 col-sm-12 col-md-6">
    			<div class="form-group">
        ...
        <button @click="updateBillingUtility" class="btn btn-primary pull-left" style="margin-right: 5px" v-show="item.invoice.payment_method != 1">Saved</button>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        updateBillingUtility() {
            var data = {
                'amount' : this.item.invoice.amount,
                'payment_date' : this.item.invoice.payment_date,
