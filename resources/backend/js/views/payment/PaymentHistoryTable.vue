<template>
    ...
    <div class="box box-widget m-margin-tb">
    	<div class="box-body">
            ...
            :headers="['Type', 'Duration', 'Due Date', 'Amount', 'Payment Method', 'Payment Date']"
            :columns="['type_id', 'name', 'duration', 'due_date', 'amount',  'payment_method', 'payment_date']"
    		:filters="filters"
    			...
    			<tbody slot="body">
                    <template v-for="item in items" v-show="item.status == show">
                        <tr >
                            ...
                            <td>
                                <a :href="item.actions.view" class="btn btn-primary btn-flat btn-sm">Receipt</a>
                            </td>
                        </tr>
                    </template>
                </tbody>
